...
const Navbar = () => {
  return (
    <div className="absolute justify-center bottom-0 mx-auto flex items-center w-full">
      <div className="bg-accent flex items-center px-4 py-3 mb-4 rounded-full w-[95%] z-[110] max-w-[25rem] justify-evenly">
