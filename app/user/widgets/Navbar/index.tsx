...
const Navbar = () => {
  return (
    <div className="absolute justify-center bottom-0 mx-auto flex items-center w-full bg-[--primary-accent] md:bg-transparent">
      <div className="bg-[--primary-accent] flex items-center px-4 py-3 w-full md:mb-4 md:rounded-full md:w-[95%] z-[110] max-w-[25rem] justify-evenly">
